...
namespace ArkosWebApplication.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            if (!String.IsNullOrEmpty(usernameOrEmail) && usernameOrEmail.Contains("@"))
            {
            ...
            ApplicationUser user = (ApplicationUser)userManager.FindByName(userName);
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    return RedirectToAction("RouteProfile", "Router", new { returnUrl = returnUrl });
